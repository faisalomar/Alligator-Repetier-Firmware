...
STEPPER_CURRENT_CONTROL
  ...
  CURRENT_CONTROL_DAC      4  //Use External DAC like Alligator
*/
...
#define CURRENT_CONTROL_DAC     4  //Use External DAC like Alligator
...
#if MOTHERBOARD == 500
#ifndef __SAM3X8E__
#error Oops!  Make sure you have 'Alligator RepRap Board' selected from the 'Tools -> Boards' menu.
#endif
...
#define TEMP_0_PIN       3 // PA6, analog pin 
#define HEATER_1_PIN     69 // PA0 
#define TEMP_1_PIN       2 // PA4, analog pin
